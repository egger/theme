 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} dyonic - Dyonic color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.dyonic.ansi, ...soft.dyonic.brightOther];
